...
public class AmiChoixArrayAdapter extends ArrayAdapter<Ami> {
    private final Context context;
    private final ArrayList<Ami> listeAmis;
    private final ArrayList<Boolean> participe;

    public AmiChoixArrayAdapter(Context context, ArrayList<Ami> listeAmis, ArrayList<Boolean> participe) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (participe.get(position)) {
            ((ImageView) rowView.findViewById(R.id.bouton_ami_ajouter)).setImageResource(R.drawable.etape_valider);
        } else {
            ((ImageView) rowView.findViewById(R.id.bouton_ami_ajouter)).setImageResource(R.drawable.etape_reset);
        }
